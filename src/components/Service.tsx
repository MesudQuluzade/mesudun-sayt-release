...
const serviceData = [
  ...
  {
    icon: <FaLaptop className="text-[40px] text-[#1E3D58] mb-4" />,
    title: "Laptop Xidmətləri",
    description: "Laptop təmiri, ehtiyat hissələri və proqram təminatı dəstəyi",
  },
  {
    icon: <FaWifi className="text-[40px] text-[#1E3D58] mb-4" />,
    ...
    <section>
      <div className="service-section mt-5">
        <div className="bg-white p-8 rounded-[15px] shadow-lg">
          <h2 className="text-[20px] font-medium mb-16 text-[#1E3D58]">Populyar xidmətlər</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {serviceData.map((service, index) => (
              ...
              >
                {service.icon}
                <h3 className="text-lg font-semibold mb-2 text-[#1E3D58]">{service.title}</h3>
