...
const ContactSection: React.FC = () => {
  return (
    <section className="contact-section">
      <div className="bg-[linear-gradient(90deg,#afa9b1,#7d7d7d)] rounded-[16px] my-[20px] p-[20px] flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="contact-actions flex flex-col items-end gap-4 md:gap-5 w-full md:w-1/2">
          ...
          <button className="bg-[#8A2BE2] text-white w-full md:w-[200px] h-[45px] text-[14px] md:text-[15px] rounded-[6px] my-[20px] md:my-[25px] p-2 shadow-[0px_4px_9px_transparent] hover:bg-[#6a1b9a] hover:shadow-[0px_2px_4px_rgba(255,255,255,0.3)] transition-colors duration-300">
